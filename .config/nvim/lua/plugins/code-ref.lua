...
vim.keymap.set({ "n", "x" }, "<leader>aa", function() yank_ref("claude", false, false) end, { desc = "Yank @file#L ref" })
vim.keymap.set({ "n", "x" }, "<leader>af", function() yank_ref("claude", false, true) end, { desc = "Yank @file ref" })
vim.keymap.set({ "n", "x" }, "<leader>yy", function() yank_ref("plain", false, false) end, { desc = "Yank file:line ref" })
vim.keymap.set({ "n", "x" }, "<leader>yf", function() yank_ref("plain", false, true) end, { desc = "Yank file path" })
vim.keymap.set({ "n", "x" }, "<leader>yY", function() yank_ref("plain", true, false) end, { desc = "Yank file:line ref (absolute)" })
vim.keymap.set({ "n", "x" }, "<leader>yF", function() yank_ref("plain", true, true) end, { desc = "Yank file path (absolute)" })
